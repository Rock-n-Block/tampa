  ...
  return (
    <div className="container lottery" id="lottery">
      ...
      <div className="lottery__rule">
        ...
        <span>
          {isParticipant
            ? 'You are a lottery participant'
            : 'You are not a participant in the lottery'}
        </span>
      </div>
      <div className="lottery__list">
        <div className="lottery__list-head">
          What you need to do to become a participant in the lottery:
        </div>
        <div className="lottery__list-item">
          Enter the auction in the first hour
        </div>
        <div className="lottery__list-subitem">
          - Tuesday, Thursday, Saturday - for every 1 MATIC you enter in the
          auction lobby, you get 1 chance to win the jackpot.
        </div>
        <div className="lottery__list-subitem">
          - Monday, Wednesday, Friday, Sunday - the same jackpot chance for
          everyone, regardless of the amount you enter the auction with.
        </div>
      </div>
      <div className="container lottery__content">
        ...
        {isOddDay && lotteryPercents && Object.keys(lotteryPercents).length ? (
          <LotteryProgress
            userAddress={userAddress}
            segments={lotteryPercents}
          />
        ) : (
          ''
        )}
        {!isOddDay && (
          <div className="lottery__info-progress">
