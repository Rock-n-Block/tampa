...
const Header = ({
  ...
  const timeCounter = (seconds) => {
    ...
    setTimeUntil(
      `${hours < 10 ? (hours < 0 ? '-0' + -hours : '0' + hours) : hours}:${
  ...
  const getDate = () => {
    contractService.currentDay().then((day) => {
      ...
      contractService.getDayUnixTime(day).then((date) => {
        const interval = setInterval(() => {
          ...
          //   let lotteryDateStart = moment.utc(date * 1000).add(20, 'minutes');
      ...
      <div className="row">
        <div className="header__content">
          <div className="header__left">
            <NavLink to="/">
              {isDarkTheme ? (
                <img src={logoImgDark} alt="" className="header__logo" />
              ) : (
          ...
          <div className="header__right m-h">
            <div className="header__token" onClick={addToken}>
              Add token
            </div>
            ...
            <div
              className={classNames('header__theme', {
                active: !isDarkTheme,
              })}>
              <span>night</span>
              <Switch
            ...
            {userAddress && (
              <div className="header__metamask">
