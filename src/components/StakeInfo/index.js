            ...
            <div className={classNames("container s-info__content", {
                ...
                <div className="s-info__item">
                    ...
                    <div className="s-info__item-subhead">Total eth dividends
                            <QuestionTooltip isDarkTheme={isDarkTheme} parent="s-info__content" tooltipText="One of the benefits of Staking Jackpot tokens is the Ethereum dividends you receive. At the end of each day, an TRX dividends pool will be calculated and allocated to all the open stakes based on their stake amount, stake length, and stake start date.<br><br> The TRX dividends pool comes from the total daily entry of the auction lobby. The only way to receive TRX Dividends is to stake your Jackpot tokens.<br><br> Not only will you get TRX dividends when you stake, but you will also be rewarded with more Jackpot tokens every day.  You can collect both the TRX and Jackpot rewards without penalty at the end of your stake, all you have to pay is your TRX gas fee.<br><br> After you exit your stakes you will receive your TRX dividends." />
                    </div>
                </div>
                <div className="s-info__item">
                    <div className="s-info__item-head">
