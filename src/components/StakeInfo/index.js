  ...
  return (
    <div className="container s-info">
      <div className="s-info__title">
        My {isActiveStakes ? 'active' : 'ended'} stakes summary info
      </div>
      <div
        className={classNames('container s-info__content', {
        ...
        <div className="s-info__item">
          ...
          <div className="s-info__item-subhead">
            {isActiveStakes ? 'Total shares' : 'total paid amount'}
          </div>
        </div>
        <div className="s-info__item">
          <div className="s-info__item-head">
            <RowItemTooltip
              tooltipText={totalDividents}
              parent="s-info__content">
              {totalDividents}
            </RowItemTooltip>
          </div>
          <div className="s-info__item-subhead">
            ...
            <QuestionTooltip
              ...
              parent="s-info__content"
              tooltipText="One of the benefits of Staking Jackpot tokens is the Ethereum dividends you receive. At the end of each day, an MATIC dividends pool will be calculated and allocated to all the open stakes based on their stake amount, stake length, and stake start date.<br><br> The MATIC dividends pool comes from the total daily entry of the auction lobby. The only way to receive MATIC Dividends is to stake your Jackpot tokens.<br><br> Not only will you get MATIC dividends when you stake, but you will also be rewarded with more Jackpot tokens every day.  You can collect both the MATIC and Jackpot rewards without penalty at the end of your stake, all you have to pay is your MATIC gas fee.<br><br> After you exit your stakes you will receive your MATIC dividends."
            />
          </div>
        </div>
        <div className="s-info__item">
