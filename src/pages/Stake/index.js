    ...
    return (
        <div className="dialog">
            ...
            <div className="dialog-text">
                <p></p>
                <p>
                    You will earn 20% APY or more on your staked Jackpot tokens, plus any bonuses for referral, stake length, and amount staked.  You will ALSO receive TRX/BNB/TRX/ or Matic dividends at the end of your stake.  Do not forget to collect your funds when the collect button appears and turns green.  Un-staking early will cause a penalty.  For more information, audit results, mathematical formulas, and all other social and information links visit <a href="https://jackpotstaking.com" target="_blank">https://jackpotstaking.com</a>
                </p>
                <p>
                    For the TRX and BSC versions of Jackpot:  <br></br>
                ...
                <p>
                    If you are using the Jackpot TRX version, and TRX has not reduced their fees yet, make sure you stake a lot of Jackpot, otherwise the gas fees could eat into your gains.  This is not an issue if you stake for 180 days and you think TRX will have resolved high gas fees by then.
            </p>
            </div>
